...
const Signup = () => {
  ...
  const signupUrl = import.meta.env.VITE_BACKEND_URL || "";
  ...
  const handleSignup = async (e) => {
    ...
    try {
      let result = await axios.post(
                        `${signupUrl}/api/v1/auth/register`,
  ...
  return (
    <div className="w-full h-[100vh] bg-slate-200 flex justify-center items-center">
      <div className="w-full max-w-[500px] h-[600px] bg-white rounded-lg shadow-gray-400 shadow-lg">
        ...
        <form className="w-full flex flex-col gap-[20px] items-center py-3" onSubmit={handleSignup}>
          <input
            type="text"
